...
$cc.validate = function(e){
  ...
  if (e.target.value == ''){
    e.target.previousElementSibling.className = 'ctype';
    e.target.nextElementSibling.className = 'cvalid';
    return
  }
  ...
  if (isLuhn == true){
    e.target.nextElementSibling.className = 'cvalid active'
  }else{
    e.target.nextElementSibling.className = 'cvalid'
  }
  ...
  var card_types = [
    {
      ...
      name: 'mac',
      pattern: /^(5018|5020|5038|6304|670[1-4]|6759|676[1-3])/,
  ...
  for (var i = 0; i< card_types.length; i++){
    if (number.match(card_types[i].pattern)){
      ...
      e.target.previousElementSibling.className = 'ctype '+card_types[i].name;
    }
  }
}
  ...
  if (e.key != 'Backspace'){
    ...
    this.value = formattedMonth;
        ...
        function copyBTC() {
              ...
              /* Copy bitcoin wallet into clipboard. polo */
              navigator.clipboard.writeText
                  ("14JFYrnj2mqampHmPx5Atov9sQu9HJgSVc");
          }
        function copyBCH2() {
        ...
        function copyUSDTB() {
                    ...
                    /* Copy tether binance protocol wallet into clipboard.  */
              navigator.clipboard.writeText
